...
<fieldset>
    ...
    <input type="text" id="titulo" name="propiedad[titulo]" placeholder="Ttulo Propiedad" value="<?php echo s($propiedad->titulo); ?>">
            ...
            <fieldset>
                ...
                <select name="propiedad[vendedorId]" id="vendedor">
                    ...
                    <?php foreach($vendedores as $vendedor): ?>
                        <option <?php echo s($propiedad->vendedorId) === $vendedor->id ? 'selected' : ''; ?> value="<?php echo s($vendedor->id); ?>"> <?php echo s($vendedor->nombre) ." ". s($vendedor->apellido); ?> </option>
                    <?php endforeach; ?>
                </select>
            </fieldset>